...
This module is the canonical runtime configuration used by FastAPI.
Pipeline path constants remain in backend/config.py.
"""
...
class Settings(BaseSettings):
    ...
    MODELS_DIR: Path = PROJECT_ROOT / "app" / "ml" / "models"
    ...
    TEMPORAL_FILE: str = "temporal_profiles.parquet"
